...
from classes import *
from populateEE import SorPopulation, SvibPopulation, \
...
def classPopulation(atomList, entropyEnergy, 
        ...
        EEclass_atomLevel,
        weighting_info, objFilePath, verbosePrint):
    '''
    ...
    for i in atomList: #iterate through each atom
        ...
        if weighting_info != None:
            if EEclass.weighting_list != None:
                weight = getWeight(EEclass, globalFrame, objFilePath)
...
def getWeight(EEclass, globalFrame, objFilePath):
    '''
